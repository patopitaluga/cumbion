...
const handleNumbers = (_wordIndex, _currentWord, _wordsCurrentLine, _scopeStatus) => {
  ...
  // Number
  if (
    // !_scopeStatus.line.writingStringLiteral && is already check in findKeywords before calling this
    (_currentWord.slice(-1) !== '"') &&
    (_scopeStatus.line.settingVar || _scopeStatus.line.printing) &&
    !isReserved(thisWordSlug) &&
    !isVariable(_wordIndex, _wordsCurrentLine, _scopeStatus) &&
